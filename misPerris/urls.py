...
from .views import buscar_nombre, info_mascota, insertar_imagen, devolver,adm_usuario,adoptar, formulario_modificar, buscar, crear_usuario, cerrar_sesion, login, filtro_tipo_boton,filtro_descripcion,filtro_tipo,detalle_mascota,index, galeria, formulario,eliminar_mascota
...
urlpatterns = [
    ...
    path('info_mascota/<id>/',info_mascota,name="INFOMASC"),
    path('buscar_nombre/',buscar_nombre,name='BUSCARNOMBRE'),
]
